...
all_blueprints = {
    ...
    "unitree-go2-hns": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_hns:unitree_go2_hns",
...
all_modules = {
    ...
    "hide-and-seek-module": "dimos.experimental.hide_and_seek.hide_and_seek_module.HideAndSeekModule",
